#
#  Be sure to run `pod spec lint ADProgressView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/ADProgressView"
  ...
  # Or just: s.author    = "Antoine DAUGUET"
  # s.authors            = { "Antoine DAUGUET" => "dauguet.antoine@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Antoine DAUGUET"
  ...
  s.source       = { :git => "https://github.com/adauguet/ADProgressView.git", :tag => "1.0.0" }
  #  s.source       = { :path => '.' }
